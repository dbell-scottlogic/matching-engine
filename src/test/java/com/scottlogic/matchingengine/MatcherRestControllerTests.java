...
//
//        Order order1 = new Order(1, 10, 10, Action.BUY, 1, new Timestamp(new Date().getTime()));
//        Order order2 = new Order(2, 10, 10, Action.BUY, 1, new Timestamp(new Date().getTime()));
//
...
//
//        Order order1 = new Order(1, 10, 10, Action.SELL,1, new Timestamp(new Date().getTime()));
//        Order order2 = new Order(2, 10, 10, Action.SELL,1, new Timestamp(new Date().getTime()));
//
//        matcherRestController.matcher.processOrder(order1);
//        matcherRestController.matcher.processOrder(order2);
//
...
////
////        HashMap<String, ArrayList<Order>> privateOrderBook = matcherRestController.getPrivateOrderBook("FakeUs.e.rn.ame");
